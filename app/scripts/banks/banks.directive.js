(function() {
  angular.module("backendfastmoneyApp").directive("demoTrackedTable", demoTrackedTable);
...
(function() {
  angular.module("backendfastmoneyApp").directive("demoTrackedTableRow", demoTrackedTableRow);
...
(function() {
  angular.module("backendfastmoneyApp").directive("demoTrackedTableCell", demoTrackedTableCell);
...
(function() {
  angular.module("backendfastmoneyApp").directive("listenerClick", listenerClick);
...
(function(){
  angular.module("backendfastmoneyApp").directive("customGroupRow", demoCustomGroupRow);
...
(function(){
angular.module("backendfastmoneyApp").directive('countClicks', function() {
  return {
    restrict: 'AE',
